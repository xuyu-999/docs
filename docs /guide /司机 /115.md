...
Open the official website of 115 Cloud and click the string behind the url when you click into the folder you want to set, such as <https://115.com/?cid=0&offset=0&tab=&mode=wangpan>, which is `249163533602609229`
...
const getQr = async ()=>{
  btnText.value = '等待...';
  state.value = 1;
  const resp = await fetch("https://api.nn.ci/proxy/qrcodeapi.115.com/api/1.0/web/1.0/b49ba39ffa2a7f09d375a2c39b43bbf6b2d53090");
